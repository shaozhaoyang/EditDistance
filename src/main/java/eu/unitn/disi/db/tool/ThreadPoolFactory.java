...
public class ThreadPoolFactory {
    private static final ExecutorService WILDCARD_SEARCH_THREAD_POOL = Executors.newFixedThreadPool(8);
    ...
    private static final ForkJoinPool FORK_JOIN_POOL = new ForkJoinPool(8);
